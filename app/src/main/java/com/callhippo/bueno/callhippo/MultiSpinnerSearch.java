...
import com.callhippo.bueno.callhippo.model.KeyPairBoolData;
import com.callhippo.bueno.callhippo.model.MultiSpinnerListener;
...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
	...
	public boolean performClick() {
		...
		ad = builder.show();
		Objects.requireNonNull(ad.getWindow()).setLayout(LayoutParams.WRAP_CONTENT, 1000);
		return true;
	}
