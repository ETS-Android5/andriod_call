...
public class ChipLayout extends ViewGroup implements View.OnClickListener{
    ...
    public ViewGroup createChips(Context context, String val, boolean setText)
    {
        ...
        Log.e("ChipLayout", "TextLength: "+length);
    ...
    public void createNewChipLayout(String val){
    ...
    public void chipCreated(ViewGroup vg){
